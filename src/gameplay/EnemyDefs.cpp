...
const EnemyDef ENEMY_DEFS[] = {
    ...
    {EnemyType::Basic, "Skeleton", 20.f, 80.f, 10.f, 14.f, 2.5f, 1.f, 1.0f, 0.f,
     "assets/Enemy_Animations_Set/enemies-skeleton1_movement.png",
     "assets/Enemy_Animations_Set/enemies-skeleton1_take_damage.png"},

    // Fast — 骷髅疾行者
    {EnemyType::Fast, "Skeleton Runner", 10.f, 160.f, 8.f, 10.f, 2.5f, 2.f, 0.7f, 30.f,
     "assets/Enemy_Animations_Set/enemies-skeleton2_movement.png",
     "assets/Enemy_Animations_Set/enemies-skeleton2_take_damage.png"},

    // Tank — 吸血鬼
    {EnemyType::Tank, "Vampire", 80.f, 50.f, 20.f, 22.f, 2.5f, 5.f, 0.4f, 60.f,
     "assets/Enemy_Animations_Set/enemies-vampire_movement.png",
     "assets/Enemy_Animations_Set/enemies-vampire_take_damage.png"},
